...
# all gained
t1 <- data.frame(
  "chromosome" = "chr1", "start" = 0, "end" = 1e4,
  "length" = 1e4, "direction" = "gain"
)
# all loss
t2 <- data.frame(
  "chromosome" = "chr1", "start" = 0, "end" = 1e4,
  "length" = 1e4, "direction" = "loss"
)
# nothing changed
t3 <- data.frame(
  "chromosome" = "chr1", "start" = c(0, 1e5), "end" = c(1e4, 2e5),
  "length" = c(1e4, 1e5), "direction" = "normal"
)
# 20/20/60
t4 <- data.frame(
  "chromosome" = "chr1", "start" = c(0, 120, 220), "end" = c(20, 140, 300),
  "length" = c(20, 20, 60), "direction" = c("gain", "loss", "normal")
)
# 40/60, 60/40
t5 <- data.frame(
  "chromosome" = "chr1", "start" = c(0, 140), "end" = c(40, 200),
...
# two "chromosome" case
t7 <- data.frame(
  "chromosome" = c("chr1", "chr2", "chrSILLY"), "start" = c(0, 120, 220),
  "end" = c(20, 140, 300), "length" = c(20, 20, 60),
  "direction" = c("gain", "loss", "normal")
)
